...
public class UserServiceImpl implements UserService {
    ...
    public UserServiceImpl(UserRepo repo, Gson gson) {
        this.repo = repo;
        this.gson = gson;
    }
    ...
    public UserDTO search(String email, String password) throws UserNotFoundException {
        ...
        try {
            User userByUsername = repo.findUserByEmailAndPassword(email,password);
...
//                return new UserDTO(userByUsername.getUsername(),userByUsername.getEmail(),userByUsername.getPassword(),objects);
    ...
    private User toEntityConverter(UserDTO userDTO){
        ...
        return new User(userDTO.getId(),userDTO.getEmail(),userDTO.getUsername(),userDTO.getPassword(),userDTO.getAddress(),userDTO.getNic(),userDTO.getDateofBirth(),
